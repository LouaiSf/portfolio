      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          >
            ...
            <span className="text-primary/40 text-sm ml-1 font-mono">.</span>
          </motion.div>
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="w-9 h-9 rounded-lg bg-primary/10 border border-primary/10 flex items-center justify-center text-primary/60 hover:text-primary hover:border-primary/30 transition-all duration-300"
            >
        ...
        <div className="mt-8 pt-6 border-t border-primary/5 text-center">
          <p className="text-xs text-muted/50">
            © {new Date().getFullYear()} Louai Soufi. Built with Next.js,
